 ...
 */
function ContentTreeCtrl($scope, $stateParams, ContentChildren, Content, ContentType, sessionService, $interpolate, ngDialog, ContentContextMenu) {
    ...
    var contentNodes = Content.query({
        'type-id': '1',
        'levels': '1'
    }, {}, function(node) {
        //console.log(node)
...
// }]);
function ContentTreeCtrlEdit($scope, $stateParams, Content, Template, ContentType, $interpolate) {
    //$scope._ = _;
    var tabs = [];
    ...
    $scope.contentNodes = $scope.contentNodes = Content.query({'node-type': '1', 'content-type':'9'},{},function(node){});
}
