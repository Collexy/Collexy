...
-- Started on 2015-06-18 15:33:28
...
--
-- TOC entry 2376 (class 0 OID 98958)
-- Dependencies: 195
...
--
-- TOC entry 2370 (class 0 OID 98785)
-- Dependencies: 189
...
--
-- TOC entry 2374 (class 0 OID 98944)
-- Dependencies: 193
...
--
-- TOC entry 2372 (class 0 OID 98797)
-- Dependencies: 191
...
--
-- TOC entry 2361 (class 0 OID 98158)
-- Dependencies: 180
-- Data for Name: data_type; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (2, 'Numeric Input', 'numeric_input', 1, '2015-03-26 23:47:44.854', '<input type="number" id="{{prop.name}}" ng-model="data.meta[prop.name]">', NULL, NULL);
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (3, 'Textarea', 'textarea', 1, '2015-03-26 23:47:44.854', '<textarea id="{{prop.name}}" ng-model="data.meta[prop.name]">', NULL, NULL);
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (5, 'Dropdown', 'dropdown', 1, '2015-03-26 23:47:44.854', '', NULL, NULL);
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (6, 'Dropdown Multiple', 'dropdown_multiple', 1, '2015-03-26 23:47:44.854', '', NULL, NULL);
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (8, 'Label', 'label', 1, '2015-03-26 23:47:44.854', '', NULL, NULL);
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (9, 'Color Picker', 'color_picker', 1, '2015-03-26 23:47:44.854', '<colorpicker>The color picker data type is not implemented yet!</colorpicker>', NULL, NULL);
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (10, 'Date Picker', 'date_picker', 1, '2015-03-26 23:47:44.854', '', NULL, NULL);
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (11, 'Date Picker With Time', 'date_picker_time', 1, '2015-03-26 23:47:44.854', '<div class="well">
...
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (13, 'Media Picker', 'media_picker', 1, '2015-03-26 23:47:44.854', '', NULL, NULL);
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (17, 'Domains', 'domains', 1, '2015-03-26 23:47:44.854', '<div>
...
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (19, 'Richtext Editor', 'richtext_editor', 1, '2015-03-26 23:47:44.854', '<textarea ck-editor id="{{prop.name}}" name="{{prop.name}}" ng-model="data.meta[prop.name]" rows="10" cols="80"></textarea>', NULL, NULL);
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (18, 'True/False', 'true_false', 1, '2015-03-26 23:47:44.854', '<div><label><input type="checkbox" type="checkbox"
        ng-model="data.meta[prop.name]"
        ng-true-value="true"
        ng-false-value="false"
       ></label> {{prop.name}}
</div>', NULL, NULL);
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (12, 'Content Picker', 'content_picker', 1, '2015-03-26 23:47:44.854', '<div ng-controller="Collexy.DataTypePropertyEditor.ContentPicker">
...
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (4, 'Radio Button List', 'radio_button_list', 1, '2015-03-26 23:47:44.854', '<div ng-controller="Collexy.DataTypePropertyEditor.RadioButtonList.Controller">
    <ul>
...
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (7, 'Checkbox List', 'checkbox_list', 1, '2015-03-26 23:47:44.854', '', NULL, NULL);
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (1, 'Text Input', 'text_input', 1, '2015-03-26 23:47:44.854', '<input type="text" id="{{prop.name}}" ng-model="data.meta[prop.name]"/>', '', 'null');
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (16, 'Upload Multiple', 'upload_multiple', 1, '2015-03-26 23:47:44.854', '<div ng-controller="Collexy.DataTypeEditor.FileUpload.Controller">
...
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (14, 'Folder Browser', 'folder_browser', 1, '2015-03-26 23:47:44.854', '<style>
    .col-ulist-3 {
	columns: 4;
	-webkit-columns: 4;
	-moz-columns: 4;
...
INSERT INTO data_type (id, name, alias, created_by, created_date, html, editor_alias, meta) VALUES (15, 'Upload', 'upload', 1, '2015-03-26 23:47:44.854', '<!--<div ng-controller="Collexy.DataTypeEditor.FileUpload.Controller" collexy-file-upload>
...
--
-- TOC entry 2366 (class 0 OID 98724)
-- Dependencies: 185
...
--
-- TOC entry 2353 (class 0 OID 98009)
-- Dependencies: 172
...
--
-- TOC entry 2360 (class 0 OID 98131)
-- Dependencies: 179
...
--
-- TOC entry 2378 (class 0 OID 98969)
-- Dependencies: 197
...
--
-- TOC entry 2380 (class 0 OID 99001)
-- Dependencies: 199
...
SELECT pg_catalog.setval('permission_id_seq', 111, true);


--
-- TOC entry 2364 (class 0 OID 98211)
-- Dependencies: 183
...
-- Completed on 2015-06-18 15:33:28
